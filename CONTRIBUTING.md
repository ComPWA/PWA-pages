...
[![Open in Visual Studio Code](https://img.shields.io/badge/vscode-open-blue?logo=visualstudiocode)](https://github.dev/ComPWA/PWA-pages)
...
```shell
git clone https://github.com/ComPWA/PWA-pages
cd PWA-pages
```
